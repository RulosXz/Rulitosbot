 ...
 *┃➤* _${usedPrefix}Proveedor / Deseas Vender Fantasmi ?_
 ...
 *┃➤* _${usedPrefix}minarFantasmicoins | minarcoins_
 ...
 *┃➤* _${usedPrefix}darFantasmicoins *cantidad*_
 ...
 *┃➤* _${usedPrefix}delAlessitacoins *@tag*_
 ...
 *┃➤* _${usedPrefix}añadirAlessitacoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🌵 𝗔𝗹𝗲𝘀𝘀𝗶𝘁𝗮 𝗕𝗼𝘁 𝗠𝗗 🌵', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
