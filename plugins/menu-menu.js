 ...
 *┃➤* _${usedPrefix}delFantasmicoins *@tag*_
 ...
 *┃➤* _${usedPrefix}añadirFantasmicoins *@tag cantidad*_
  ╰━━━━━━━━━━━━━
`.trim()
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', menu, fkontak, false, { contextInfo: {mentionedJid, externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '🌵 𝗙𝗮𝗻𝘁𝗮𝘀𝗺𝗶 𝗕𝗼𝘁 𝗠𝗗 🌵', previewType: 0, thumbnail: imagen4, sourceUrl: redesMenu.getRandom()}}})
