...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE PINGUIBOT 🌟`}
...
const smsLista7 = () => { return `🐈 INSTALAR PINGUIBOT 🐈`}
...
//main.js
const smsWelcome = () => { return `*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 𝗕𝗶𝗲𝗻𝘃𝗲𝗻𝗶𝗱𝘅 𝗔𝗹 𝗚𝗿𝘂𝗽𝗼 🐧*\n*╟❧𝗟𝗲𝗲 𝗟𝗮 𝗗𝗲𝘀𝗰𝗿𝗶𝗽𝗰𝗶𝗼𝗻 𝗚𝗰𝘀 ❤️*\n*╚══════════════*\n@desc`}
const smsBye = () => { return '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝗔𝗹 𝗙𝗶𝗻 𝟭 𝗕𝗮𝘀𝘂𝗿𝗮 𝗠𝗲𝗻𝗼𝘀 𝗘𝗻 𝗘𝗹 𝗚𝗿𝘂𝗽𝗼 🗑️*\n*╟❧ 𝗧𝗼𝘁𝗮𝗹 𝗡𝗼 𝗡𝗼𝘀 𝗛𝗮𝗰𝗶𝗮𝘀 𝗙𝗮𝗹𝘁𝗮 😹*\n*╚══════════════*'}
...
//_allantilink.js
const smsTextoYT = () => { return '𝗘𝘀𝘁𝗲𝗳𝗮 𝗕𝗼𝘁 🌸 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽'} 
...
//_antiviewonce.js
const smsAntiView = () => { return `*Jaja Pingui Bot Lo Ve Todo 🐧*`} 
...
const smsContacto4 = () => { return 'Contacto Oficial de Pingui Bot 🐧'}
